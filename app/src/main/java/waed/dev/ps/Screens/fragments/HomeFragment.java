...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // init the firebaseController instance
    ...
    @NonNull
    private ArrayList<News> fetchNewsData() {
    ...
    private void fetchNewsDataFireStore(){

        var newsCollection = firebaseController.getDatabase().collection("News");
        newsCollection.get().addOnSuccessListener(queryDocumentSnapshots -> {
            for (QueryDocumentSnapshot snapshot: queryDocumentSnapshots) {
                Log.i("HF", "fetchNewsDataFireStore: snapshot"+snapshot.getData());
            }
        }).addOnFailureListener(e -> Log.e("HF", "fetchNewsDataFireStore: e", e));
    }
    ...
    private void setupListener() {
        binding.statisticsCard.setOnClickListener(view -> startActivity(new Intent(getActivity(), StatisticsActivity.class)));
...
//            startActivity(new Intent(getActivity(), PdfActivity.class));
        ...
        binding.cardsCard.setOnClickListener(view -> startActivity(new Intent(getActivity(), CardsActivity.class)));

        binding.postersCard.setOnClickListener(view -> startActivity(new Intent(getActivity(), DesignsActivity.class)));
    }
}